...
def get_isaac_sim_remappings(mode: NvbloxMode, num_cameras: int,
    ...
    if lidar: #0711 Add. below "else" line was here before.
        if use_realsense:
            remappings.append(('pointcloud', '/camera0/realsense_splitter_node/output/pointcloud'))
        else:
...
def generate_launch_description() -> LaunchDescription:
    ...
    args.add_arg('lidar', 'True')      # ← ✅ 0711 Add
